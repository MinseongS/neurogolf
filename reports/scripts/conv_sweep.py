...
Usage: PYTHONPATH=. .venv/bin/python reports/scripts/conv_sweep.py [task,task,...|auto]
...
# load the solver module directly
spec = importlib.util.spec_from_file_location("conv_fit", "reports/scripts/conv_fit.py")
