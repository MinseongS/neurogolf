...
Usage: PYTHONPATH=. .venv/bin/python reports/scripts/conv_fit.py N [--write] [--k 1,3,5]
...
def emit_custom(W, B, k, N=0):
    ...
    body = f'''"""task{N:03d} — single-Conv fit (auto-generated by reports/scripts/conv_fit.py).
