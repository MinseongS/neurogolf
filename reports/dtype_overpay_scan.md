...
**Total potential delta_points (headline, FP16_SAFE+U8_CANDIDATE recasts): +7.555** across all tasks.
...
| class | count | meaning |
|---|---|---|
| FP16_SAFE | 160 | integer, |v|<=2048, no dilated-MaxPool; save bytes/2 (u8 blocked by einsum/topk) |
| U8_CANDIDATE | 586 | integer 0..255, no einsum/topk/dilated-MaxPool; save 3*bytes/4 |
...
| FLOOR | 281 | non-integer OR |v|>2048; genuinely needs fp32 |

## Top-30 tasks by delta_points (163 have delta>0)
...
| 234 | 2886 | 64 | 17.0104 | 340 | 17.1329 | +0.1225 | yes | present9 (U8_CANDIDATE, [9], 27B, max=69.0) |
...
| 224 | 2460 | 371 | 17.0516 | 210 | 17.1287 | +0.0771 | yes | row_has (U8_CANDIDATE, [1, 1, 30, 1], 90B, max=1.0) |
