...
def build(task):
    inits = [
        ...
        tensor('pad_grid4', arr_b64('')),
        tensor('pad_grid5', arr_b64('')),
    ...
    nodes = [
        ...
        helper.make_node('Pad', ['p4_grid_u8', 'pad_grid4'], ['p4_grid_10'], mode='constant'),
        helper.make_node('Pad', ['p5_grid_u8', 'pad_grid5'], ['p5_grid_10'], mode='constant'),
    ...
    return model('task185_live_exact', nodes, inits, output_dtype=9, opset=13, value_infos=value_infos)
